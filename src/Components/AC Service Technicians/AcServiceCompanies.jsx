...
const AcServiceCompanies = ({ company }) => {
                ...
                <div className="card-body p-0" id='card-main'>
                    <div className="row g-sm-4 mb-4">
                        ...
                        <div className="col-sm-3 col-md-3 col-xl-3">
                            <img src={company.description_image} alt="image" className='rounded-2 object-fit-cover'/>
                        </div>
                        {/* <!-- Card image end-->
                        ...
                        <div className="col-sm-9 col-md-9 col-xl-9">
                            <h4 className="card-title" id='company-main'>
                                ...
                                <span className='company-names'>
                                    ...
                                    <Link to={`/${company.service_slug}/${company.slug}`} onClick={scrollToTop} className='text-dark' style={{fontSize:'25px'}} id='company-name'>{company.company_name}</Link>
                            ...
                            <div className='col-sm col-md col-xl'>
                                <div className='row'>
                                    ...
                                    <div className="col-sm col-md col-xl text-sm-end" id='enquired'>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <form onSubmit={submitQuery} className='row g-3 needs-validation' >
                                <div className="mb-3">
                                ...
                                <div className="mb-3">
                                    ...
                                    <textarea name="query" required className="form-control" id="query" cols="30" rows="3" value={queryForm.query} onChange={handleInputChange}></textarea>
                                </div>
...
export default AcServiceCompanies